...
CREATE TABLE IF NOT EXISTS skills (
  ...
  skill_type VARCHAR(50) NOT NULL DEFAULT 'general',
  level INTEGER CHECK (level >= 0 AND level <= 100) DEFAULT 0,
  description_en TEXT,
  description_th TEXT,
  certifications TEXT[] DEFAULT '{}',
  technologies TEXT[] DEFAULT '{}',
  last_used VARCHAR(100),
  sort_order INTEGER DEFAULT 0,
  is_active BOOLEAN DEFAULT true,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
...
-- =============================================
-- 6. WORK GALLERY IMAGES TABLE (รูปการทำงาน)
-- =============================================
CREATE TABLE IF NOT EXISTS work_gallery_images (
  id SERIAL PRIMARY KEY,
  image_file VARCHAR(255) NOT NULL,
  image_path VARCHAR(255) NOT NULL DEFAULT '/imgws/',
...
-- =============================================
-- 7. CONTACT INFO TABLE (ข้อมูลติดต่อ)
-- =============================================
...
DROP TRIGGER IF EXISTS update_work_gallery_images_updated_at ON work_gallery_images;
CREATE TRIGGER update_work_gallery_images_updated_at
